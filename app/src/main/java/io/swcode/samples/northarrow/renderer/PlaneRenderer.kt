...
import io.swcode.samples.northarrow.filament.TextureType
import io.swcode.samples.northarrow.filament.loadTexture
...
class PlaneRenderer(context: Context, private val filament: FilamentContext) {
    companion object {
